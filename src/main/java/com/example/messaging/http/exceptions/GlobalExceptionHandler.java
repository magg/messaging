...
import com.example.messaging.domain.Constants;
import com.example.messaging.domain.ErrorResponse;
...
public class GlobalExceptionHandler {
    ...
    private ErrorResponse getErrorResponse(Throwable throwable, HttpExchange exchange) throws IOException {
        ErrorResponse.Builder responseBuilder = ErrorResponse.newBuilder();
